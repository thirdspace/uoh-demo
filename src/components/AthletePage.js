      ...
      <div className="athlete-full">
        ...
        <div className="athlete">
          ...
          <section className="description">
            Small time medalist from <strong><Flag code={athlete.country} showName="true"/></strong>,
            born of {athlete.birth} (Find out more on <a href={athlete.link} target="_blank">Wikipedia</a>).
          </section>
